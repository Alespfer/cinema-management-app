/*
 * BilletDialogue.java
 * Fenêtre affichant le récapitulatif final d'une commande (billets et snacks).
 * Propose une option pour exporter ce récapitulatif en fichier texte.
 */
...
class BilletInfo {
    ...
    String tarifLibelle;
    String prixTotal;
    List<LignePanier> panierSnacks;
}

public class BilletDialog extends javax.swing.JDialog {

    private final String contenuBillet;

    public BilletDialog(java.awt.Frame parent, boolean modal, BilletInfo infos) {
        super(parent, modal);
    ...
    /**
     * Génère la chaîne de caractères formatée représentant le ticket complet.
     */
    ...
    private void exportTxt() {
        ...
        // On vérifie si l'utilisateur a bien cliqué sur "Enregistrer" (APPROVE_OPTION).
        if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            
            // Si oui, on récupère le fichier qu'il a choisi.
