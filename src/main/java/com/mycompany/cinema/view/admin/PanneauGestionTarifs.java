/*
 * PanneauGestionTarifs.java
 * Panneau pour la gestion des tarifs (Plein, Étudiant, etc.).
 */
...
public class PanneauGestionTarifs extends javax.swing.JPanel {
    ...
    /**
     * Charge ou recharge la liste des tarifs depuis le service.
     */
    private void chargerListeTarifs() {
        try {
            listModel.clear();
            List<Tarif> tarifs = adminService.trouverTousLesTarifs();
    ...
    /**
     * Met à jour les champs du formulaire avec les détails d'un tarif.
     */
    ...
    /**
     * Gère la sauvegarde (création ou modification) d'un tarif.
     */
    private void actionEnregistrer() {
        ...
        try {
            if (tarifSelectionne == null) { // --- Création ---
    ...
    /**
     * Gère la suppression du tarif sélectionné.
     */
