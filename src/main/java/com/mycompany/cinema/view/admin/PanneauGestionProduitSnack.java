/*
 * PanneauGestionProduitsSnack.java
 * Panneau pour la gestion des produits de snacking.
 */
...
public class PanneauGestionProduitSnack extends javax.swing.JPanel {

    private final AdminService adminService;
    private ProduitSnack produitSelectionne;
    private DefaultListModel<ProduitSnack> listModel;

    public PanneauGestionProduitSnack(AdminService adminService) {
    ...
    /**
     * Initialise le modèle de la JList et son moteur de rendu.
     */
    ...
    /**
     * Charge ou recharge la liste des produits depuis le service.
     */
    ...
    /**
     * Met à jour les champs du formulaire avec les détails d'un produit.
     */
    ...
    private void actionEnregistrer() {
        try {
            ...
            if (produitSelectionne == null) { // Mode Création
                // 1. Obtention d'un nouvel ID unique
                int nouvelId = com.mycompany.cinema.util.IdManager.obtenirProchainIdProduitSnack();
