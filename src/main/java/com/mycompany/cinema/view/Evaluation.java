...
public class Evaluation extends javax.swing.JDialog {
    ...
    private int filmId;
    // CORRECTION : Le type doit être précis.
    private EvaluationClient evaluationExistante;

    /**
     * Constructeur pour une NOUVELLE évaluation.
     */
    public Evaluation(java.awt.Frame parent, ClientService clientService, int clientId, int filmId) {
        super(parent, "Donner votre avis", true);
        this.clientService = clientService;
        this.clientId = clientId;
        this.filmId = filmId;
        this.evaluationExistante = null; // Mode Création
        initComponents();
     ...
     */
    public Evaluation(java.awt.Frame parent, ClientService clientService, EvaluationClient evaluation) {
        super(parent, "Modifier votre avis", true);
        this.clientService = clientService;
        this.evaluationExistante = evaluation; // Mode Modification
        // On déduit les ID depuis l'objet fourni
        this.clientId = evaluation.getIdClient();
        this.filmId = evaluation.getIdFilm();
        initComponents();
        preRemplirFormulaire(); // On remplit le formulaire avec les anciennes données
        setLocationRelativeTo(parent);
    }
    ...
    private void gererValidation() {
        ...
        try {
            if (evaluationExistante == null) { // --- MODE CRÉATION ---
                ...
                // NOTE : Assurez-vous que votre service a une méthode "modifierEvaluation"
